...
const LinkItems = [
...

  {
    ...
    collapse: true,
    children: [
      { name: "Sales & Support ", path: "/Sales&Support", icon: FiTrendingUp },
      { name: "Accounts ", path: "/Accounts", icon: FiTrendingUp },
      { name: "Operations ", path: "/Operations", icon: FiTrendingUp },
      { name: "Directors ", path: "/Directors", icon: FiTrendingUp },
    ],
  },
  {
    name: "Reports",
    ...
    children: [
      {
        ...
        path: "/MasterSalesReport",
        icon: FiTrendingUp,
      },
      {
        name: "Master Travel Report ",
        path: "/MasterTravelReport",
        icon: FiTrendingUp,
      },
      {
